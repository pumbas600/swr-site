...
<Callout type="default" emoji="✅">
   In Next.js App Router, all components are React Server Components (RSC) by default. **You can only import the key serialization APIs from SWR in RSC.**
</Callout>
...
<Callout type="error">
   You can not import any other APIs from SWR since they are not available in RSC.
</Callout>
